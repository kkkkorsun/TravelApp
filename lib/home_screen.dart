...
import 'package:travelapp/detail-screen.dart';
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.only(left: 18.0),
                child: Text('Uzbekistan ranks 4th in the world in gold reserves.',
              ...
              Padding(
                padding: const EdgeInsets.only(left: 18.0),
                child: Text('Tashkent is one of the rare megalopolises where you can see the starry sky at night.',
                    style: TextStyle(color: Colors.grey[20], fontSize: 14.0)),
              ),
              SizedBox(
                height: 2.0,
              ...
              Padding(
                padding: const EdgeInsets.only(left: 18.0),
                child: Text('Specialists call Uzbekistan a state whose economy is faster than most other countries on the planet in terms of growth.',
                    style: TextStyle(color: Colors.grey[20], fontSize: 14.0)),
              ),
              SizedBox(
                height: 20.0,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              fit: BoxFit.cover,
                              image: AssetImage('assets/packlogo.jpg'))),
                    ),
                    Positioned(
                      top: 120.0,
                      left: 230.0,
